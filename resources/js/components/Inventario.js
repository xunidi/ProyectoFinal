              ...
              <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p>Esta seguro desea de eliminar el registro del inventario?</p>
                  </div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
...

                    {
                      ...
                      :
                      <button type="button" class="btn btn-primary" onClick={()=>this.sendNetworkInventario()}>Guardar</button>
                     }
                  </div>
                </div>
              </div>
